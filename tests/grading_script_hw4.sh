...
if [ "$server_pid" ]
then
  python3 fsmain.py -port 8000 -cid 0 < hw4_2023_test$t.in > hw4_2023_test$t.out
fi
kill $server_pid
...
then
  touch c0_shell
  touch c1_shell
  tail -f c0_shell | python3 fsmain.py -port 8000 -cid 0 > hw4_2023_test$t._c0.out &
  sleep 3
  tail -f c1_shell | python3 fsmain.py -port 8000 -cid 1 > hw4_2023_test$t._c1.out &
  sleep 3
...
rm temp.out temp.err
sleep 3
cp hw4_2023_test$t._c0.out hw4_2023_test$t.out
cat hw4_2023_test$t._c1.out >> hw4_2023_test$t.out
...
then
  touch c0_shell
  touch c1_shell
  tail -f c0_shell | python3 fsmain.py -bs 256 -nb 256 -is 32 -ni 32 -port 8000 -cid 0 > hw4_2023_test$t._c0.out &
  sleep 3
  tail -f c1_shell | python3 fsmain.py -bs 256 -nb 256 -is 32 -ni 32 -port 8000 -cid 1 > hw4_2023_test$t._c1.out &
  sleep 3
  cat hw4_2023_test$t.in | while read shell_line
  do
    echo "${shell_line#*:}" >> c${shell_line%:*}_shell
